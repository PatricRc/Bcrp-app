...
import { CalendarIcon, Download, FileDown, FileText, Loader2 } from "lucide-react";
...
export function ResumenIndicador({ indicadores }: ResumenIndicadorProps) {
  ...
  // Crear configuración del gráfico para shadcn charts
    ...
    <div className="flex flex-col gap-6 w-full">
      ...
      <Card className="w-full">
        ...
        <CardContent>
          ...
          {vistaActiva === "grafico" ? (
            /* Gráfico mejorado */
            <div className="h-auto pt-2 mb-8">
              <IndicadorChart 
                datos={datosGrafico}
      ...
      {/* Sección de análisis (separada en una Card independiente) */}
      {indicadores.length > 0 && (
        <Card className="w-full mt-4">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg">Análisis de Indicadores</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            {/* Análisis de IA */}
            <div className="rounded-lg bg-white p-4 mt-4 border border-gray-100 shadow-sm">
              {cargandoAnalisis ? (
                ...
                <div className="prose max-w-none">
                  <h3 className="text-xl font-semibold mb-4 text-blue-800">Análisis de {datosIndicadores[pestanaActiva]?.nombre || "Indicador"}</h3>
